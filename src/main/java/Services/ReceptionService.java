...
Config config = new Config("BC130/WS/CRONUS%20France%20S.A./Codeunit/Reception");
	...
	public void addToReception(String IDCommande,String IDItem,String IDUser) {
		...
		//creation de l'envelope soap
				...
				SoapObject soapRequest = new SoapObject("urn:microsoft-dynamics-schemas/codeunit/Reception", "Insert");
				...
				try {//
					 httpTransport.call("urn:microsoft-dynamics-schemas/codeunit/Reception:Insert", soapEnvelope);
